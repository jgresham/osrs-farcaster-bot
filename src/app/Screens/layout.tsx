    ...
    <div className="flex flex-col min-h-screen">
      <header className="flex justify-between items-center p-5">
        <div className="flex items-center">
          <Image
            src="/logos/osrs-farcaster-bot-logo.png"
            width={60}
            height={60}
            alt="OSRS Farcaster Bot Logo"
          />
          <h1 className="text-xl font-extralight font-bold ml-3">{process.env.NEXT_PUBLIC_APP_NAME}</h1>
        </div>
